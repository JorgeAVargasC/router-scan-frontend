    ...
    <div className='min-h-full grid place-items-center flex-1'>
      ...
      <div className='border p-5 bg-slate-900 border-slate-800 shadow-2xl shadow-slate-800 rounded-md w-full sm:w-[350px]'>
        <form onSubmit={handleSubmit}>
          ...
          {loading ? (
            <div
              className='text-white grid place-items-center min-w-full bg-slate-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center'
            >
              <svg
